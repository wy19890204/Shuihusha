...
public:
    ...
    const Card *askForCard(ServerPlayer *player, const char *pattern,
                           const char *prompt, bool is_skill, const QVariant &data, const char *skill_name);
    const Card *askForCard(ServerPlayer *player, const char *pattern,
                           const char *prompt, bool is_skill, const QVariant &data = QVariant(),
                           Card::HandlingMethod method = Card::MethodDiscard, ServerPlayer *to = NULL, bool isRetrial = false, const char *skill_name = NULL);
    bool askForUseCard(ServerPlayer *player, const char *pattern, const char *prompt, bool is_skill, int notice_index = -1, Card::HandlingMethod method = Card::MethodUse);
