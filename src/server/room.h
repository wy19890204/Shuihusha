...
public:
    ...
    const Card *askForCard(ServerPlayer *player, const QString &pattern, const QString &prompt, bool is_skill, const QVariant &data, const QString &skill_name);
    const Card *askForCard(ServerPlayer *player, const QString &pattern, const QString &prompt, bool is_skill, const QVariant &data = QVariant(),
                           Card::HandlingMethod method = Card::MethodDiscard, ServerPlayer *to = NULL, bool isRetrial = false,
                           const QString &skill_name = QString());
    bool askForUseCard(ServerPlayer *player, const QString &pattern, const QString &prompt, bool is_skill, int notice_index = -1,
