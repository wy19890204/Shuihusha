...
void StandardPackage::addGenerals(){
    General *caocao, *zhangliao, *guojia, *xiahoudun, *simayi, *zhenji;
    ...
    General *liubei, *zhangfei, *machao, *zhugeliang, *huangyueying;
    ...
    General *sunquan, *ganning, *daqiao, *sunshangxiang;
