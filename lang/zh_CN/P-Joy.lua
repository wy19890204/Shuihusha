...
-- generals
	...
	["maque"] = "麻雀",
	["timer"] = "计时",
	[":timer"] = "锁定技，回合开始时，你失去1点体力或1点体力上限。",
	["lingyu"] = "领域",
	[":lingyu"] = "锁定技，除了【肉】，你的所有牌都无法按牌面说明使用。",
	["wurao"] = "勿扰",
	[":wurao"] = "锁定技，你受到的伤害均无效。",
	["eding"] = "额定",
	[":eding"] = "锁定技，分发起始手牌时，共发你13张牌作为手牌。任何时候，你的牌（包括“碰”牌）只能有13张，除非满足游戏结束条件。",
	["zhuangche"] = "撞车",
	[":zhuangche"] = "若其他角色进入弃牌堆的牌正好和你手中对子的点数相同，你可以将其凑成一副置于你的武将牌上，称为“碰”。",
	["zouma"] = "走马",
	[":zouma"] = "锁定技，你的判定、出牌、弃牌阶段自动跳过。摸牌阶段，你只能摸一张牌，之后须将满足一副规则的牌作为“碰”置于你的武将牌上。",
	["jizha"] = "叽喳",
	[":jizha"] = "锁定技，当你有七个对子，或只有一个对子，其余全是“碰”牌的时候（此时总牌数为14张），游戏结束。你所在的阵营获得游戏胜利。",
}
