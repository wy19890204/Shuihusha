...
local t = {
	...
	["#Jink"] = "%from 使用了【闪】",
	["#AxeSkill"] = "%from 使用了战神斧的技能，弃置了两张牌对 %to 强制命中",
	[":slash"] = "出牌时机：出牌阶段\
...
使用目标：除你以外，任意一名角色。\
作用效果：将【画地为牢】横置于目标角色判定区里，目标角色回合判定阶段，进行判定；若判定结果不为红桃，则跳过目标角色的出牌结算，将【画地为牢】弃置",
...
武器特效：出牌阶段，你可以使用任意张【杀】",
	[":double_sword"] = "攻击范围：２\
武器特效：你使用【杀】时，指定了一名异性角色后，在【杀】结算前，你可以令对方选择一项：自己弃置一张手牌或者让你从牌堆摸一张牌",
...
武器特效：当你需要使用（或打出）一张【杀】时，你可以将两张手牌当一张【杀】使用（或打出）",
	[":axe"] = "攻击范围：３\
武器特效：目标角色使用【闪】抵消你使用【杀】的效果时，你可以弃置两张牌，则【杀】依然造成伤害",
	[":halberd"] = "攻击范围：４\
