...
视为你对任意一名角色使用一张【杀】（不计入每回合使用限制）",
	...
	["xiaoguo"] = "骁果",
	[":xiaoguo"] = "当你使用【杀】造成伤害时，你可以进行一次判定。若为黑桃，你立即获得之。若为梅花，你可以对除受伤角色外额外的一名角色使用一张【杀】",
	...
	["lixin"] = "离心",
	[":lixin"] = "觉醒技，当你脱离濒死状态时，你回复1点体力或莫两张牌，并永久获得技能“离间”和“帷幕”",

	["lvlingqi"] = "吕玲琦", -- 3
	["dancer"] = "舞双",
	[":dancer"] = "锁定技，你使用【杀】时，目标角色需弃一张手牌和使用一张【闪】才能抵消。与你进行决斗的角色每次须打出一张【杀】和一张手牌。",
	["fuckmoon"] = "蔽月",
	[":fuckmoon"] = "回合结束阶段，你从牌队中随机获得一张牌并展示。然后获得之。",
}