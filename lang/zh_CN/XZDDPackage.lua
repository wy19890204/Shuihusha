...
return {
	...
	["linchong"] = "林冲",
	["duijue"] = "对决",
	[":duijue"] = "你每使用【杀】造成一次伤害或受到一次【杀】造成的伤害，可以令任一其他角色进行一次判定：若结果不为黑桃，则视为你对其使用了一张【决斗】（不能被【无懈可击】或【将计就计】响应）。",
	["@duijue"] = "你可以指定一名其他角色进行【对决】",
	["$duijue1"] = "八十万禁军教头，豹子头林冲是也！",
	["$duijue2"] = "一枪在手，试问天下英雄！",

	["#_zhutong"] = "美髯公", 
	["zhutong"] = "朱仝",
	["yixian"] = "义先",
	[":yixian"] = "每当你对其他角色造成伤害时，你可以防止此伤害，改为弃掉该角色的一张牌。若如此做，你摸一张牌。",
	["$Yixian"] = "%from 弃掉了 %to 的 %card，抵消了 %to 受到的所有伤害",
	["$yixian1"] = "事不宜迟，兄弟快走！",
...
★【顺水】的发动级别优先于【八卦阵】。",
	...
	["@binggong"] = "你可以将等于两者差数的手牌【秉公】给其他角色",
	...
	["@feiqiang"] = "请弃掉一张闪，否则由 %src 执行【飞枪】的效果",
