...
return {
	...
	["zhengfa"] = "征伐",
	[":zhengfa"] = "出牌阶段，你可以和一名与你性别不同且没受伤的角色拼点。若你赢，你可以分别对你攻击范围内的至多X名其他角色造成1点伤害，X为你当前的体力值。若你没赢，你须将你的武将牌翻面。每回合限一次。",
	["zhengfaeft"] = "^o^",
	["@zhengfa-effect"] = "征伐成功！你可以点击【^o^】按钮，分别对你攻击范围内的至多X名其他角色造成1点伤害，X为你当前的体力值",
	["$zhengfa1"] = "区区草寇，何足为患？",
	["$zhengfa2"] = "就此一并剿灭了！",
	["$zhengfa3"] = "区区草寇，何足为患？",
	["$zhengfa4"] = "就此一并剿灭了！",
