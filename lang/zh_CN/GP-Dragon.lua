...
return {
	...
	["shuizhen"] = "水阵",
	[":shuizhen"] = "当任一角色受到火焰伤害时，你可以弃置一张手牌，防止该伤害；其他角色每受到一次来源不为你的雷电伤害，你可以弃置一张基本牌，分别对除你和该角色外的所有角色造成1点雷电伤害。",
	["yanmo"] = "淹没",
	[":yanmo"] = "你每受到1点无属性伤害，可以选择一项：弃置任一角色装备区里的武器牌和防具牌，或弃置任一角色装备区里的所有坐骑牌。",
	["@shuizhen1"] = "你可以弃一张手牌发动【水阵】，防止 %src 受到的火焰伤害",
	["@shuizhen2"] = "%src 受到了雷电伤害，你可以弃一张基本牌发动【水阵】，让其他角色也尝尝雷电的滋味儿~",
	["#Shuizhen"] = "%from 发动了技能【%arg】，防止了 %to 受到的火焰伤害",
