...
-- png emotions
	...
	["^question"] = "质疑",
	["^no-question"] = "不质疑",
	["^victim"] = "当你(男)成为杀的目标时，头上出现的“好汉，且慢”效果",
	["^victimf"] = "当你(女)成为杀的目标时，头上出现的“哎呀，讨厌”效果",
-- rcc emotions
	["awake"] = "觉醒效果",
	["limited"] = "限定效果",
	["chain"] = "铁索连环",
	...
	["^avoid"] = "当你受到的伤害被防止时播放",
	["^chain"] = "使用铁索连环时播放",
	["^damage"] = "受到1点或0点普通伤害时播放",
	["^damage2"] = "受到2点普通伤害时播放",
	["^damage3"] = "受到3点或以上普通伤害时播放",
	["^death"] = "阵亡时播放",
	["^revive"] = "复活时播放，主要用于转世规则",
	...
	["^lightning"] = "被闪电劈中或受到3点及以上雷电伤害时播放",
	["^limited"] = "当你发动限定技时播放",
	["^no-success"] = "拼点没赢时播放",
