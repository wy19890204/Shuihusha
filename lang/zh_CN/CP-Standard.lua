...
武器特效：当你使用的【杀】被【闪】抵消时，你可以弃置两张牌，则此【杀】依然造成伤害",
	...
	[":halberd"] = "装备牌·武器\
攻击范围：４\
武器特效：<b>锁定技</b>，当你使用【杀】时，若目标角色的手牌数大于其当前体力值，则该【杀】不能被【闪】响应。",
	["#Halberd"] = "%from 装备的【%arg】生效，对 %to 的杀直接命中",
...
出牌时机：出牌阶段。\
使用目标：一名其他角色。\
作用效果：将【画地为牢】放置于目标角色判定区里，目标角色回合判定阶段进行判定；若判定结果不为红桃，则跳过其的出牌阶段，将【画地为牢】置入弃牌堆",
